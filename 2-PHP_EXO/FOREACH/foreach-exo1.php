...
foreach ($compositeursItaliens as $nom ) {
    echo $nom = substr($nom, 0, -13)."\n";
    //on affiche le nom en sectionnant le string, on sélectionne de la lettre 0 à la lettre -13(la 13e en partant de la fin)
}
