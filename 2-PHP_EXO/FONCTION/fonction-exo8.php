...
var_dump(nombres_entiers(10, 5))."\n";
var_dump(nombres_entiers(2, 8))."\n";
var_dump(nombres_entiers(7, 7))."\n";
var_dump(nombres_entiers('foo', 5))."\n";
var_dump(nombres_entiers(10, 'bar'))."\n";
var_dump(nombres_entiers('foo', 'bar'))."\n";