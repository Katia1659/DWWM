...
for ($i = 0; $i <= 100; $i++) {
    ...
    } elseif ($reste_des_dizaines == 6) {
        $unite = 'six';
    } elseif ($reste_des_dizaines == 7) {
        $unite = 'sept';
    } elseif ($reste_des_dizaines == 8) {
        $unite = 'huit';
    } elseif ($reste_des_dizaines == 9) {
        $unite = 'neuf';
    }
    ...
    if ($i == 0) {
        ...
        $nombre = $dizaine;
    } else if ($i>10 && $reste_des_dizaines == 1 && $reste_des_centaines != 80) {
        $liaison_dizaine = '-et-';
