...
// On change la structure if en structure switch
...
switch (true) {
    case $carte_fidelite && $demande  <= $places_normales ||  $carte_fidelite && $demande <= $places_carte_fidelite || !$carte_fidelite && $demande <= $places_normales  :
        echo "la réservation est enregistrée\n";
        break;
    default : 
        echo "il n'y a pas assez de places\n";
