            ...
            <form  method="post" action="">
                <tr>
                    ...
                    <td class="text-center nom-pre">
                        <input name="ID<?= $i?>" type="hidden" value="<?= $_SESSION['stagiaires'][$i]['ID'] ?>">
                        <?= $_SESSION['stagiaires'][$i]['ID'] ?>
                    </td>
                    <td class="text-center nom-pre">
                        <input type="text" name="NOM<?= $i?>" value="<?= $_SESSION['stagiaires'][$i]['NOM'] ?>"
                               class="form-nom-pre text-center form-control"  required>
                    </td>
                    <td class="text-center nom-pre">
                        <input type="text" name="PRENOM<?= $i?>" value="<?= $_SESSION['stagiaires'][$i]['PRENOM'] ?>"
                               class="form-nom-pre text-center form-control" required>
                    ...
                    <td class="text-center nom-pre">
                        <button type="button"
                                onclick="updateStag('update','[name = ID<?= $i?>]',
                                        '[name =NOM<?= $i?>]','[name =PRENOM<?= $i?>]');"
                                class="btn btn-primary btnSize">Modifier
                        </button>
                    </td>
