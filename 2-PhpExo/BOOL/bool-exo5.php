...
// switch ($carte_fidelite && $demande <= $places_carte_fidelite || $carte_fidelite && $demande <= $places_normales || !$carte_fidelite && $demande <= $places_normales) {
//     case 0:
...
switch (true) {
    case ($carte_fidelite && $demande <= $places_carte_fidelite || $carte_fidelite && $demande <= $places_normales || !$carte_fidelite && $demande <= $places_normales):
    echo "la réservation est enregistrée\n";
        break;
