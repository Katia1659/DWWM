...
<?php   } ?>
  ...
  <form action="../controller/execute4.php" method="post" class="form-example">
  <div class="form-example">
    <label for="name"></label>
    <input class="form-form-control form-control-lg" type="text" name="supprimer" id="name" placeholder="Place :" required>

  <input class="btn btn-secondary" class="submit" name="submit" type="submit" value="supprimer" require />
    </form>
</div>
