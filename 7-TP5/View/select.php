...
<body>
    ...
    <h1 class=" d-flex justify-content-around  mt-1  centre"> <a href="../View/index.html"><svg fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48" class="" file="red">
        ...
        <a href="../View/insert.php" type="" class=""><svg fill="lightgreen"
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48" class="opacity-75">
                <path
        ...
        <a href="../Controller/exec_Select.php" class="" ><svg fill="aqua"
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48" class="opacity-75">
                <path
        ...
        <a href="../View/update.php" class="" ><svg fill="orange"
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48" class="opacity-75">
                <path
        ...
        <a href="../View/delete.php" type="button" class="" style="height: 5rem; width: 20rem"><svg fill="red"
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48" class="opacity-75">
                <path
