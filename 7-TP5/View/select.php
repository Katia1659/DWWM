...
<head>
    <meta charset="utf-8"/>
    <title>Tableau stagiaires</title>
...
<header>
    ...
    <h1 class="text-center">TAB des Stagiaires</h1>
    <div class="iconNav">
    ...
    <table class="table table-light table-bordered">
        ...
        for ($i = 0; $i < count($_SESSION['stagiaires']); $i++) { ?>
            <tr>
                ...
                <td class="text-center place"><?= $_SESSION['stagiaires'][$i]['PLACE'] ?></td>
            </tr>
