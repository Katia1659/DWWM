...
<head>
  ...
  <link rel="stylesheet" href="./asset/updateStyle.css">
...
<body>
  ...
  <form action="../Controller/executeUpdate.php" method="post" class="form-example">
    <div class="form-example">
      <label for="name">Place: </label>
      <input type="int" name="place" id="name" required>
    </div>
