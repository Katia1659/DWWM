...
<div class="bouton2">
<!-- <button type="button" onclick="location.href='../controller/file.csv'">Télécharger le fichier au format CSV</button> -->
<form action="../controller/executeFunctions3.php" method="get">
         <input type="submit" class="btn" value="Télécharger le fichier au format CSV" />
                  </form>
</div>
</body>
</html>