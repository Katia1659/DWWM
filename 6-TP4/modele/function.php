...
function saveListStagToJson(array $listStagPlaces): string{
    ...
    $resultat = file_put_contents("../controller/JASON/postes_pc_version.json", $json, true);
    ...
    //partie de la fonction à utiliser pour la faire fonctionner avec le terminal
