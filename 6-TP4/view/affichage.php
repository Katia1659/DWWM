...
<form action="../controller/executeRand.php" method="get">
    <input class="bouton" type="submit" value="Alea Jacta Est" />
</form>
<form action="../controller/executePlaces.php" method="get">
    <input class="bouton" type="submit" value="SOL INVICTUS" />
</form>
...
<form action="../controller/executeGenerateCsv.php" method="get">
    <input class="bouton" type="submit" value="extraire la liste" />
</form>
