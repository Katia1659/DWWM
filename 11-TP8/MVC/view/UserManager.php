...
<nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
  ...
  <main class="flexmain">   
    ...
    <form action="../controller/Execute_UserDelete.php" method="post">
      ...
      <center>
      <input type="submit" style="width : 10em" name="submit" class="btn btn-outline-danger" value="Supprimer">
      </center>
    </form>
  </div>
  </div>  
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                  <li class="nav-item">
                    ...
                    </svg> Instagram</a><a class="nav-link ms-5" href="https://twitter.com/Maksen_cs"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
