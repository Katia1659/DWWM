      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav menu">
          <a class="nav-link active text-light" aria-current="page"
            href="../controller/executeInfraction.php">Infractions</a>
  ...
  <footer class="navbar fixed-bottom navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
    <div class="container-fluid">
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link ms-5" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
              ...
              </svg> Instagram</a><a class="nav-link ms-5" href="https://twitter.com/Maksen_cs"><svg
