...
for ($i = 0; $i <= 100; $i++) {
    ...
    // exceptions 90+
    if ($i == 91) {
        $nombre = 'quatre-vinght-onze';
    } else if ($i == 92) {
        $nombre = 'quatre-vinght-douze';
    } else if ($i == 93) {
        $nombre = 'quatre-vinght-treize';
    } else if ($i == 94) {
        $nombre = 'quatre-vinght-quatorze';
    } else if ($i == 95) {
        $nombre = 'quatre-vinght-quinze';
    } else if ($i == 96) {
        $nombre = 'quatre-vinght-seize';
    } else if ($i == 97) {
        $nombre = 'quatre-vinght-dix-sept';
    } else if ($i == 98) {
        $nombre = 'quatre-vinght-dix-huit';
    } else if ($i == 99) {
        $nombre = 'quatre-vinght-dix-neuf';
    }
