...
la variable `$compositeursItaliens` est un tableau associatif contenant
une liste de couples clé / valeur de compositeurs italiens avec leur période de vie
...
source des données : [Liste de compositeurs de la période classique 
— Wikipédia](https://fr.wikipedia.org/wiki/Liste_de_compositeurs_de_la_p%C3%A9riode_classique)
